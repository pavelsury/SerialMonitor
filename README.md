...
\
To give it a try, first download file PipeScripts.zip from latest release's assets and unzip.\
...
- **SerialMonitor2.exe** contains everything to run the app but is little bit bigger.
- **SerialMonitor2_without_framework.exe** is pretty small but it doesn't contain .NET framework. Means, you can be asked to download and install .NET framework in case your Windows doesn't have it installed yet.
